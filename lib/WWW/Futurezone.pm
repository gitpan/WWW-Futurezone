...
WWW::Futurezone - Perl extension for getting news http://futurezone.orf.at/

=head1 SYNOPSIS

use WWW::Futurezone;
my $obj           =  WWW::Futurezone->new();
...
WWW::Futurezone - Perl extension for getting news from http://futurezone.orf.at/
