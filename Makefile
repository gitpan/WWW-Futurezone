# This Makefile is for the WWW::Futurezone extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/WWW/Futurezone.pm]
#     AUTHOR => q[Sebastian Enger <thecerial@>]
#     NAME => q[WWW::Futurezone]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/WWW/Futurezone.pm]
...
MAKE = make
FULLEXT = WWW/Futurezone
BASEEXT = Futurezone
PARENT_NAME = WWW
DLBASE = $(BASEEXT)
VERSION_FROM = lib/WWW/Futurezone.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/WWW/Futurezone.pm
...
TO_INST_PM = lib/WWW/Futurezone.pm

PM_TO_BLIB = lib/WWW/Futurezone.pm \
	blib/lib/WWW/Futurezone.pm
...
DISTNAME = WWW-Futurezone
DISTVNAME = WWW-Futurezone-1.0
...
manifypods : pure_all  \
	lib/WWW/Futurezone.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/WWW/Futurezone.pm $(INST_MAN3DIR)/WWW::Futurezone.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                WWW-Futurezone' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             1.0' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            Perl extension for getting news http://futurezone.orf.at/' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for getting news http://futurezone.orf.at/</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/WWW/Futurezone.pm blib/lib/WWW/Futurezone.pm 
